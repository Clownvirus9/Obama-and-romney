...
function draw() {
  ...
  strokeWeight(4);
  textSize(30);
  text("Drag Obama to mitt romneys clones and ensure democratic victory", 80, 50);
  pop();
  ...
  imageMode(CENTER);
  image(obamaIMG, ball.position.x, ball.position.y, 50, 45);
...
function keyPressed() {
	...
	if(keyCode === 32) {
		Matter.Body.setPosition(obama.body, {x:85, y:200})
